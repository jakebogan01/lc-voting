    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            <div class="relative">
                ...
                <div class="hidden absolute z-10 w-[26rem] text-left font-semibold text-sm bg-white shadow-lg rounded-xl mt-2">
            ...
            <div class="relative">
                ...
                <div class="absolute z-20 w-[19rem] text-left font-semibold text-sm bg-white shadow-lg rounded-xl mt-2">
